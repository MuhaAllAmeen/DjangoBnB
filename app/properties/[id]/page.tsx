        ...
        <main className="max-w-[1500px] mx-auto px-6 pb-6">
            ...
            <div className='mt-4 grid grid-cols-1 md:grid-cols-5 gap-4'>
                <div className='py-6 pr-6 col-span-3'>
                    ...
                    <span className='mb-6 block text-lg text-gray-600'>Guests: {property.guests} <br /> {property.bedrooms} bedroom <br /> {property.bathrooms} bathroom</span>
                    <hr />
                    <Link href={`/landlords/${property.landlord.id}`} className='py-6 flex items-center space-x-4 ' >
                        {property.landlord &&  property.landlord.avatar_url && (
                            <Image src={property.landlord.avatar_url} width={50} height={50} className='rounded-full' alt='user'/>
                        )}
